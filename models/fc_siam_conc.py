...
import sys
sys.path.append("..")  # Adjust the path to import from models.fc_ef_help
from models.fc_ef_help._block import Conv3x3, MaxPool2x2, ConvTransposed3x3
from models.fc_ef_help._utils import Identity
...
if __name__ == "__main__":
    ...
    fc_fe = SiamUNet_conc(in_ch=3, out_ch=2)
    # img = torch.rand([8, 3, 256, 256])
    # res = fc_fe(img, img)
    # print(res.shape)
    input1 = torch.randn(1, 3, 256, 256)
    flops1, params1 = profile(fc_fe, inputs=(input1,input1))
