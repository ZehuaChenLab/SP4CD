...
if __name__ == "__main__":
    ...
    arconv = ARConv(16, 16, kernel_size=3, padding=1, stride=1, l_max=9, w_max=9, flag=False, modulation=True)
    out = arconv(x, epoch=50, hw_range=[1, 3])
    print(out.shape)  # Expected output shape: (2, 16, 32, 32)