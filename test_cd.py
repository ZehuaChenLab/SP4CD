...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='/home-nv1/2024xlh/CDProject/config/whu_mamaba/whu_other_test.json',
        ...
        if load_path is not None:
            ...
            with torch.no_grad():
                for current_step, test_data in enumerate(test_loader):
                    ...
                    #     pred_img = cd_model(test_img1, test_img2, epoch=200, hw_range=[1, 3])
                    # else:
